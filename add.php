...
[$cm, $course, $moduleinstance, $tabs, $currenttype] = utils::page_requirements('add');

$params = ['id' => $cm->id, 'currentype' => $currenttype];
$formname = "\\mod_competvet\\form\\{$currenttype}_add";
