...
/**
 * A case log has been viewed. We rely on the fact that case_entry is the object
 * being viewed and that the event is triggered when the case_entry is viewed.
 *
