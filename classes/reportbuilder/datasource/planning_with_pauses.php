...
class planning_with_pauses extends datasource {
    ...
    public static function get_name(): string {
        return get_string('report:planning_pauses', 'mod_competvet');
    }
    ...
    public function get_default_columns(): array {
        return [
            ...
            'planning:session',
            'group:name',
            'planning_pause:startdate',
            'planning_pause:enddate',
        ];
    }
    /**
    ...
    protected function initialise(): void {
        ...
        $planningalias = $planning->get_table_alias('competvet_planning');
        $this->set_main_table('competvet_planning', $planningalias);
        $this->add_entity($planning);

        // Join planning to planning pauses.
        $planningpauseentity = new planning_pause();
