 ...
 */
class planning_pause extends base {
    /**
    ...
    protected function get_default_entity_title(): lang_string {
        return new lang_string('entity:planning_pause', 'mod_competvet');
    }
    ...
    protected function get_all_columns(): array {
        $planningalias = $this->get_table_alias('competvet_planning_pause');
