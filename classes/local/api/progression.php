...
class progression {
     ...
     */
    public const int STATE_NOT_EVALUATED = 0;

    /**
     * Progression state: evaluated but not acquired.
     */
    public const int STATE_EVALUATED_NOT_ACQUIRED = 1;

    /**
     * Progression state: acquired.
     */
    public const int STATE_ACQUIRED = 2;
     ...
     */
    public const int DEFAULT_ACQUISITION_THRESHOLD = 80;

    /**
     * Maximum level value used in the system (level 50 = no grade).
     */
    public const int MAX_USABLE_LEVEL = 49;

    /**
     * Minimum level value used in the system.
     */
    public const int MIN_USABLE_LEVEL = 1;
