 ...
 */
class case_form_edit extends dynamic_form {
    /**
     * Define form
     */
    ...
    public function set_data_for_dynamic_submission(): void {
        ...
        $caseentry = cases::get_entry($entryid);
        $data = [
            'cmid' => $this->optional_param('cmid', null, PARAM_INT),
            'entryid' => $entryid,
            'studentid' => $caseentry->studentid,
        ];
        foreach ($caseentry->categories as $category) {
            foreach ($category->fields as $field) {
                $data['field_' . $field->id] = $field->value;
            }
        }
