...
/**
 * Student competency progression renderable.
 *
 * Displays a consolidated view of a student's competency progression
 ...
 */
class student_progression extends base {
    /**
    ...
    public function export_for_template(renderer_base $output): array {
        ...
        foreach ($this->progression as $criterionid => $criterion) {
                $criterialist[] = [
                    ...
                    'maxlevel' => $criterion->bestlevel !== null ? progression::MAX_USABLE_LEVEL : '',
