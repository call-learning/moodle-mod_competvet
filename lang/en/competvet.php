...
$string['orphanuser'] = 'Orphan user';
$string['orphanuserfix'] = 'Fix orphan user';
$string['orphanfix:add'] = 'Add user back to group {$a}';
$string['orphanfix:move'] = 'Move orphan user to group {$a}';
