...
$string['deleteallinfo'] = 'This will delete all planning data, including user data. This action cannot be undone.';
...
$string['historicalplanning'] = 'Historical planning';
$string['historicalplanningreadonly'] = 'This planning is historical and read-only.';
