...
$string['evaluation_grid:selector'] = 'Evaluation grid selector';
$string['evaluation_grid:name'] = 'Evaluation grid name';
$string['evaluation_grid:idnumber'] = 'Evaluation grid idnumber';
$string['entity:evaluation_grid'] = 'Evaluation grid';
...
$string['observation_context:name'] = 'Observation context name';
$string['observation_context:context'] = 'Observation context content';
$string['observer:fullname'] = 'Observer Fullname';
$string['entity:observation_context'] = 'Observation context';
...
$string['progress_createobservations'] = 'Creating observations';
...
$string['report:evaluationgrids'] = 'Evaluation grids report';
...
$string['planningstatus:current'] = 'Current';
$string['planningstatus:observerlate'] = 'Late';
$string['planningstatus:observercompleted'] = 'Finies';
...
$string['mobileview:observer:groupinfo']  = '{$a->groupname} ({$a->nbstudentstoeval} student left) ';
