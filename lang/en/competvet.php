...
$string['allsituations'] = 'All situations for course {$a}';
...
$string['caseentry:content'] = 'Case entry content';
$string['caseentry:field'] = '{$a}';
$string['caseentry:timecreated'] = 'Case entry time created';
$string['caseentry:timemodified'] = 'Case entry time modified';
$string['caselog:addtitle'] = 'Add a clinical case transmission';
$string['caselog:cancel'] = 'Cancel';
$string['caselog:edittitle'] = 'Edit the clinical case transmission';
$string['caselog:savedraft'] = 'Save draft';
$string['caselog:validate'] = 'Validate';
$string['caselog_default_version'] = 'Default caselog version';
$string['caselog_default_version_desc'] = 'The version selected here will be used as the current version for new caselog entries. Changing this will update the current version immediately.';
$string['caselog_schema_missing'] = 'Caselog form schema file not found: {$a}';
$string['caselogfieldtoolong'] = 'This field is limited to {$a} characters maximum.';
$string['caselogversion'] = 'Caselog form version';
$string['caselogversion_desc'] = 'Select the default caselog form version for new entries.';
...
$string['competvet:manageglobalcriteria'] = 'Manage global CompetVet criteria';
...
$string['confirmplanningdeleteall'] = 'Delete all';
...
$string['defaultcriteria'] = 'Default criteria';
$string['defaultcriteria_help'] = 'Default criteria are fixed, only the criteria text can be changed';
$string['defaultlang_help'] = 'Default language for the emails, Current setting <strong>{$a}</strong>';
$string['delete'] = 'Delete';
$string['deleteallinfo'] = 'This will delete all planning data, including user data. Plannings of deleted groups are kept. This action cannot be undone.';
$string['deleteallplanning'] = 'Delete all planning';
$string['deleteexistingroles'] = 'Delete existing role assignments';
$string['downloadplanning'] = 'Download planning';
$string['duplicategrid'] = 'Duplicate grid';
$string['duplicategridconfirm'] = 'Are you sure you want to duplicate this grid?';
$string['edit'] = 'Edit';
...
$string['enabledroles'] = 'Enabled roles for assignment';
...
$string['entity:competvet_case_entry'] = 'Case log entries';
...
$string['entity:planning_pause'] = 'Planning Pause';
$string['entity:progression'] = 'Competency progression';
...
$string['historicalgroupunknown'] = 'Deleted group (ID {$a})';
$string['historicalplanning'] = 'Deleted group';
$string['historicalplanningreadonly'] = 'This planning is read-only because its group has been deleted.';
$string['immediate_email'] = 'Send notifications immediately';
$string['immediate_email_desc'] = 'If disabled use the notification UI to batch send emails.';
$string['inuse'] = 'In use';
...
$string['manageglobalcriteria'] = 'Manage global CompetVet criteria';
...
$string['notification:deleteall'] = 'Delete all {$a} notifications';
$string['notification:end_of_planning'] = 'End of planning';
$string['notification:items_todo'] = 'Items todo';
$string['notification:message'] = 'Message';
$string['notification:notification'] = 'Notification';
$string['notification:recipient'] = 'Recipient';
$string['notification:sendall'] = 'Send all {$a} notifications';
$string['notification:status:pending'] = 'Pending';
$string['notification:status:send'] = 'Sent';
...
$string['orphanfix:add'] = 'Re-add to group {$a}';
$string['orphanfix:move'] = 'Move to group {$a}';
$string['orphanfixed:add'] = 'User re-added to group {$a}';
$string['orphanfixed:move'] = 'Records moved to group {$a}';
$string['orphanuser'] = 'Misplaced';
$string['orphanuserfix'] = 'Fix';
$string['pauseplanningadd'] = 'Add planning pause';
...
$string['planningcategory:paused'] = 'Paused';
$string['planningimportedsuccess'] = 'Planning imported successfully';
...
$string['report:case_entries'] = 'Case log entries report';
$string['report:caselogentries'] = 'Report on case log entries';
$string['report:competency_progression'] = 'Competency progression report';
...
$string['selectcompetvet'] = 'Select a Situation';
...
$string['situation:haslettergrades'] = 'Enable letter grades';
$string['situation:haslettergrades_help'] = 'By selecting a letter-based grading scale, students do not have access to their score out of 100 but instead receive a letter grade based on the following scale: F: between 0 and 40, FX: between 41 and 50, E: between 51 and 60, D: between 61 and 70, C: between 71 and 80, B: between 81 and 90, A: between 91 and 100.';
...
$string['studentnotingroup'] = 'This student is not a member of the planning group';
