...
$string['caselog:addtitle'] = 'Ajouter une transmission de cas clinique';
$string['caselog:cancel'] = 'Annuler';
$string['caselog:edittitle'] = 'Modifier la transmission de cas clinique';
$string['caselog:savedraft'] = 'Enregistrer le brouillon';
$string['caselog:validate'] = 'Valider';
$string['caselog_default_version'] = 'Version par défaut du caselog';
$string['caselog_default_version_desc'] = 'La version sélectionnée ici sera utilisée comme version courante pour les nouvelles entrées caselog. La modification de ce paramètre mettra à jour la version courante immédiatement.';
$string['caselog_schema_missing'] = 'Fichier de schéma du formulaire Caselog introuvable : {$a}';
$string['caselogfieldtoolong'] = 'Ce champ est limité à {$a} caractères maximum.';
$string['caselogversion'] = 'Version du formulaire Caselog';
$string['caselogversion_desc'] = 'Sélectionnez la version par défaut du formulaire caselog pour les nouvelles entrées.';
...
$string['competvet:manageglobalcriteria'] = 'Gérer les critères globaux CompetVet';
...
$string['competvetreportlist'] = 'Liste des raports CompetVet';
...
$string['confirmplanningdeleteall'] = 'Supprimer tout';
...
$string['deleteallinfo'] = 'Cette action supprimera toutes les données de planification, y compris les données des utilisateurs. Les planifications des groupes supprimés sont conservées. Cette action est irréversible.';
$string['deleteallplanning'] = 'Supprimer toute la planification';
$string['deleteexistingroles'] = 'Supprimer les attributions de rôles existantes';
$string['downloadplanning'] = 'Télécharger planning';
$string['duplicategrid'] = 'Dupliquer la grille';
$string['duplicategridconfirm'] = 'Êtes-vous sûr de vouloir dupliquer cette grille ?';
...
$string['entity:planning_pause'] = 'Pause de planification';
$string['entity:progression'] = 'Progression des compétences';
...
$string['historicalgroupunknown'] = 'Groupe supprimé (ID {$a})';
$string['historicalplanning'] = 'Groupe supprimé';
$string['historicalplanningreadonly'] = 'Cette planification est en lecture seule car son groupe a été supprimé.';
...
$string['manageglobalcriteria'] = 'Gérer les critères globaux CompetVet';
...
$string['no_previous_data'] = 'Aucune donnée d\'observation précédente';
...
$string['orphanfix:add'] = 'Réajouter au groupe {$a}';
$string['orphanfix:move'] = 'Déplacer vers le groupe {$a}';
$string['orphanfixed:add'] = 'Utilisateur réajouté au groupe {$a}';
$string['orphanfixed:move'] = 'Données déplacées vers le groupe {$a}';
$string['orphanuser'] = 'Déclassé';
$string['orphanuserfix'] = 'Corriger';
...
$string['planning_external_format:enddate'] = 'End Date';
$string['planning_external_format:groupname'] = 'Group Name';
$string['planning_external_format:planningpauseend'] = 'Pause_end_{$a}';
$string['planning_external_format:planningpausestart'] = 'Pause_start_{$a}';
$string['planning_external_format:session'] = 'Session';
$string['planning_external_format:startdate'] = 'Start Date';
...
$string['planningimportedsuccess'] = 'Planning importé avec succès';
...
$string['progression_filter_acquired'] = 'Acquises uniquement';
$string['progression_filter_all'] = 'Tous les états';
$string['progression_filter_evaluated_not_acquired'] = 'Évaluées mais non acquises uniquement';
$string['progression_filter_not_evaluated'] = 'Non évaluées uniquement';
$string['progression_filter_state'] = 'Filtrer par état';
$string['progression_no_criteria'] = 'Aucun critère d\'évaluation n\'est configuré pour cette planification.';
$string['progression_state_acquired'] = 'Acquise';
$string['progression_state_evaluated_not_acquired'] = 'Évaluée - non acquise';
$string['progression_state_not_evaluated'] = 'Non évaluée';
$string['progression_summary'] = 'Résumé de la progression';
$string['progression_summary_acquired'] = 'Acquises : {$a}';
$string['progression_summary_evaluated_not_acquired'] = 'Évaluées mais non acquises : {$a}';
$string['progression_summary_not_evaluated'] = 'Non évaluées : {$a}';
$string['progression_title'] = 'Progression des compétences';
$string['progression_view_observer'] = 'Progression des compétences pour l\'observation';
$string['progression_view_report'] = 'Rapport de progression des compétences';
$string['progression_view_student'] = 'Progression des compétences de l\'étudiant';
$string['report:case_entries'] = 'Rapport des cas cliniques';
$string['report:caselogentries'] = 'Rapport des entrées de cas cliniques';
$string['report:competency_progression'] = 'Rapport de progression des compétences';
...
$string['studentnotingroup'] = 'Cet étudiant n\'est pas membre du groupe de la planification';
...
$string['task:refresh_progression'] = 'Actualiser les résultats de progression des compétences';
