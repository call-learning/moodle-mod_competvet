...
$string['orphanuser'] = 'Utilisateur orphelin';
$string['orphanuserfix'] = 'Corriger l\'utilisateur orphelin';
$string['orphanfix:add'] = 'Ajouter un utilisateur au groupe {$a}';
$string['orphanfix:move'] = 'Déplacer l\'utilisateur orphelin vers le groupe {$a}';
