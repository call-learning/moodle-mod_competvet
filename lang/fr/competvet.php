...
$string['competvet:managecompetencyframeworks'] = 'Gérer les cadres de compétences CompetVet';
...
$string['gradeitem:caselog'] = 'Note du journal de cas';
...
$string['observation_comment:comment'] = 'Contenu du commentaire d\'observation';
$string['evaluator:role'] = 'Évaluateur';
$string['evaluator:role:desc'] = 'Rôle d\'évaluateur : un utilisateur avec ce rôle peut observer un étudiant et lui donner une note (évaluation, journal de cas, liste)';
...
$string['report:criteria'] = 'Rapport de critères';
...
$string['situation:evalnum'] = 'Nombre d\'évaluations requises';
$string['situation:evalnum_help'] = 'Nombre d\'évaluations requises';
$string['situation:autoevalnum'] = 'Nombre d\'autoévaluations requises';
$string['situation:autoevalnum_help'] = 'Nombre d\'autoévaluations requises';
$string['situation:certifpnum'] = 'Pourcentage de certification requis';
$string['situation:certifpnum_help'] = 'Pourcentage de certification requis';
...
$string['situation:evalgrid'] = 'Grille d\'évaluation';
$string['situation:listgrid'] = 'Grille de liste';
$string['situation:certifgrid'] = 'Grille de certification';
...
$string['planningcategory:current'] = 'Actuel';
$string['planningcategory:future'] = 'Futur';
$string['planningcategory:observerlate'] = 'En retard';
...
$string['observation:comment:privatecomment'] = 'Commentaire privé';
$string['observation:comment:progress'] = 'Progrès';
$string['observation:comment:improvement'] = 'Amélioration';
...
$string['closeevaluation'] = 'Clore l\'évaluation';
...
$string['evaluate'] = 'Évaluation globale';
$string['certify'] = 'Certifier';
$string['list'] = 'Liste';
...
$string['entercertificationassesment'] = 'entrez vos évaluations de certification ici';
$string['more'] = 'plus';
$string['less'] = 'moins';
$string['points'] = '{$a} points';
$string['managecriteria'] = 'Gérer les critères';
$string['list_criteria'] = 'Liste des critères';
$string['certif_criteria'] = 'Critères de certification';
$string['eval_criteria'] = 'Critères d\'évaluation';
$string['evalevaluation'] = 'Évaluation Éval';
...
$string['finalscore'] = 'Note finale proposée';
...
$string['freecommenteval'] = 'Commentaire libre pour la partie Éval';
...
$string['certifevaluation'] = 'Évaluation Certif';
...
$string['evaluatordecision_help'] = 'La non-validation étant un obstacle, vous pouvez changer manuellement cette note. Si vous forcez la validation, veuillez commenter.';
$string['evalcomment'] = 'Commentaire libre sur les aspects cliniques essentiels';
...
$string['nocertifications'] = 'Aucune certification';
