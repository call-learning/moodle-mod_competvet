...
Feature: Manage Plannings
  ...
  Scenario: Add a new planning
    ...
    And I update date "startdate" to "last week" in row number "1"
    And I update date "enddate" to "next week" in row number "1"
  ...
  Scenario: Add a planning pause
    ...
    And I update date "startdate" to "yesterday" in row number "2"
    And I update date "enddate" to "tomorrow" in row number "2"
